...
class MyApp(QWidget):
    ...
    def PRD(self):
        ...
        for id, label in enumerate(rack_dump):
            self.w2.cell(8 * id + 2, 2).value = "Cop_label : " + str(len(total_COP_s[id])) + "EA"
            self.w2.cell(8 * id + 2, 1).value = "AOC_label : " + str(len(total_AOC_s[id])) + "EA"
    ...
    def MOR(self):
        ...
        self.w1.cell(3, 1).value = "Long Copper [20m]"
