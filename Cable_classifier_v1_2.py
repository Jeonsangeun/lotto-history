...
class MyApp(QWidget):
    ...
    def MOR(self):
            ...
            if device[idx_device][-2:] == 'M0' and device[idx_SPort][:3] == 'ETH':
                ...
                while idx <= idx_End:
                    if (idx - idx_Start) // 2 == 0:
                        ...
                        if (idx - idx_Start) % 2 == 0:
                            MPO['Start'].append(device[idx][:-3] + "P1-4")
                        else:
        ...
        self.w1.cell(69, 1).value = "MPO "
        self.w1.cell(69, 2).value = str(len(MPO['Start'])) + "EA"
        self.w1.cell(69, 3).value = "Option"
        self.w1.cell(69, 1).font = self.tile_font
