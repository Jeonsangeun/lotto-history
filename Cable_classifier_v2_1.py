...
from PyQt5.QtWidgets import QApplication, QWidget, QPushButton, QHBoxLayout, QVBoxLayout, QComboBox, QLabel, QFileDialog, QMessageBox
...
class MyApp(QWidget):
    ...
    def initUI(self):
        ...
        hbox1.addWidget(self.PRD_res_url)
        hbox1.addStretch(1)
    ...
    def PRD(self):
        ...
        self.wb.save("PRD_label_filter.xlsx")
    ...
    def MOR(self):
        ...
        for value in range(T1_num):
            PSM4_list[value] = [i + "\n" + j for i, j in zip(PSM4_dict[str(value) + 'Start'], PSM4_dict[str(value) + 'End'])]
        ...
        self.w1.cell(copper_start_l, 1).value = "Long Copper [12m]"
        ...
        self.w1.cell(copper_start_s, 1).value = "Short Copper[7m]"
        ...
        self.w1.cell(IDF_start+1, 1).value = "SM-LC (9m)"
        ...
        self.w1.cell(90, 1).value = "MPO "
        self.w1.cell(90, 2).value = str(len(MPO['Start'])) + "EA"
        self.w1.cell(90, 3).value = "Option"
        self.w1.cell(90, 1).font = self.tile_font
